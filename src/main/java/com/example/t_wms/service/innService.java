...
public interface innService {
    ...
    String addInn(String orderId,int productId,int supplierId,int productNum,String info,double pay,String token) throws JsonProcessingException;
//    String updateInnById(int id,String orderId,int productId,int supplierId,int productNum,String info,String token) throws JsonProcessingException;
    String updateInnById(int id,String info,String token) throws JsonProcessingException;
