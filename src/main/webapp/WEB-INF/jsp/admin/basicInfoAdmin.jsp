...
<script>
    new Vue({
        ...
        methods: {
            ...
            {
                window.location.href="/admin/warehouseAdmin";
            },
            jumpToTypeAdmin()
            {
                window.location.href="/admin/typeAdmin";
            },
            jumpToSupplierAdmin()
            {
                window.location.href="/admin/supplierAdmin";
            },
            jumpToCustomerAdmin()
            {
                window.location.href="/admin/customerAdmin";
            },
            jumpToProductAdmin()
            {
