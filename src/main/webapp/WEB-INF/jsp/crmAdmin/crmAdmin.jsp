...
<div id="app" v-cloak>
    <el-container>
        ...
        <el-container>
            <%@ include file="../public/crmAdmin/aside.jsp" %>
            <el-main id="elMain">
                <div>
                    <el-card>
                        <el-row :gutter="20">
                                ...
                                <template slot-scope="scope">
                                    <el-tooltip effect="dark" content="查看回访详情" placement="top" :enterable="false">
                                        <el-button type="warning" icon="el-icon-search" size="mini"
                                                   v-if="username === scope.row.staffName"
                                                   @click="viewVisitList(scope.row.customerId)"></el-button>
                                        <el-button type="warning" icon="el-icon-search" size="mini"
                                                   v-else disabled></el-button>
                                    </el-tooltip>
                                </template>
                            </el-table-column>
                        </el-table>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            back()
            {
                window.location.href="/crmAdmin/basicInfoAdmin";
            },
        }
    })
</script>
