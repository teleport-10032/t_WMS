...
<el-aside width="220px" id="elAside">
    <el-menu background-color="#333744"
        ...
        <el-menu-item index="3" style="width: 220px" @Click="jumpToInAdmin">
            <i class="el-icon-help" id="inAdminIco"></i>
            <span slot="title" id="inAdmin">采购入库信息管理</span>
        </el-menu-item>
        <el-menu-item index="4" style="width: 220px" @Click="jumpToOutAdmin">
            <i class="el-icon-s-shop" id="outAdminIco"></i>
            <span slot="title" id="outAdmin">生产销售出库信息管理</span>
        </el-menu-item>
        <el-menu-item index="5" style="width: 220px" @Click="jumpToInventoryAdmin">
