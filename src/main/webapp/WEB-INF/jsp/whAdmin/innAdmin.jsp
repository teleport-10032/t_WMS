...
<%--                            <el-table-column label="实付款(元)" prop="pay" min-width="5%"></el-table-column>--%>
<%--                            <el-table-column label="备注" prop="info" min-width="5%"></el-table-column>--%>
                            <el-table-column label="操作" width="210px">
                                <template slot-scope="scope">
                                    ...
                                    <div v-else>
                                        <el-tooltip effect="dark" content="查看" placement="top" :enterable="false">
                                            <el-button type="warning" icon="el-icon-search" size="mini"
                                                       @click="viewInn(scope.row.id)" disabled></el-button>
                                        </el-tooltip>
                                        <el-tooltip effect="dark" content="编辑" placement="top" :enterable="false">
                                            <el-button type="primary" icon="el-icon-edit" size="mini"
                                                       @click="editInn(scope.row.id)" disabled></el-button>
                                        </el-tooltip>
                                        <el-tooltip effect="dark" content="删除" placement="top" :enterable="false">
                                            <el-button type="danger" icon="el-icon-delete" size="mini"
                                                       @click="deleteInnById(scope.row.id)" disabled>
                                            </el-button>
                                        </el-tooltip>
                                    </div>
                                </template>
                    ...
                    <el-dialog title="添加入库信息" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed"
                        ...
                        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="70px">
                            ...
                            <el-form-item label="实付款(元)" prop="pay">
                                <el-input v-model="addForm.pay" @keyup.enter.native="addInn"></el-input>
                            </el-form-item>
                    ...
                    <el-dialog title="编辑入库信息" :visible.sync="editDialogVisible" width="500px" @close="editDialogClosed"
                        ...
                        <el-form :model="editForm" :rules="addFormRules"  ref="editFormRef" label-width="70px">
                            ...
                            <el-form-item label="实付款(元)" prop="pay">
                                <el-input v-model="editForm.pay" @keyup.enter.native="editInnSubmit" disabled></el-input>
                            </el-form-item>
                            <el-form-item label="操作员">
                                <el-input v-model="editForm.staffName" readonly></el-input>
                            </el-form-item>
                            <el-form-item label="备注" prop="info">
                    ...
                    <el-dialog title="查看入库信息" :visible.sync="viewDialogVisible" width="500px" @close="viewDialogClosed"
                        ...
                        <el-form :model="editForm" ref="viewFormRef" label-width="100px">
                            ...
                            <el-form-item label="实付款(元)">
                                <el-input v-model="editForm.pay" readonly></el-input>
                            </el-form-item>
                            <el-form-item label="操作员">
                                <el-input v-model="editForm.staffName" readonly></el-input>
                            </el-form-item>
